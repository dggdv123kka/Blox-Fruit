...
██║  ██║███████╗╚██████╗██║  ██║███████╗██║ ╚═╝ ██║   ██║       ██║  ██║╚██████╔╝██████╔╝
╚═╝  ╚═╝╚══════╝ ╚═════╝╚═╝  ╚═╝╚══════╝╚═╝     ╚═╝   ╚═╝       ╚═╝  ╚═╝ ╚═════╝ ╚═════╝ 
Create By Alchemy Hub --------------------------- Kaitan Script Open-Source [ 29/6/2023 ]
< Alchemy#9999 / Copyright © Alchemy 2023 >
		...
		if library.objects and (#library.objects > 0 or next(library.objects)) then
			...
			pcall(function()
				if library.Backdrop then
					...
					library.Backdrop.ImageTransparency = (library_flags["__Designer.Background.ImageTransparency"] or 10) / 100
				end
			end)
		end
	end
...
function library:CreateWindow(options, ...)
	...
	innerBackdrop.ImageTransparency = (library_flags["__Designer.Background.ImageTransparency"] or 10) / 100
...
task.spawn(function() pcall(function()  while wait() do if game.PlaceId == 2753915549 then WolrdSet3:Set("World : 1 ".."✅") end end end) end)
task.spawn(function() pcall(function() while wait() do if game.PlaceId == 4442272183 then WolrdSet:Set("World : 2 ".."✅") end end end) end)
task.spawn(function() pcall(function() while wait() do if game.PlaceId == 7449423635 then WolrdSet1:Set("World : 3 ".."✅") end end end) end)
...
LibraryNotify:Notification({ Text = "\67\114\101\97\116\101\32\66\121\32\58\32\65\108\99\104\101\109\121\32\72\117\98", Duration = 12 })
...
local LibraryNotify = loadstring(game:HttpGet("https://raw.githubusercontent.com/ZoiIntra/luable/main/notify.lua"))()
LibraryNotify:Notification({ Text = "\74\111\105\110\32\68\105\115\99\111\114\100\32\58\32\104\116\116\112\115\58\47\47\100\105\115\99\111\114\100\46\103\103\47\100\85\100\122\90\115\107\66\67\67", Duration = 12 })
...
-----------Bypass
function ByPass(Position)game.Players.LocalPlayer.Character.Head:Destroy()game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = Position wait(.1)game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = Position game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetSpawnPoint")end
------------------AutoFaarm
    ...
    if OldWolrd then
        ...
        elseif MyLevel == 10 or MyLevel <= 14 then
			...
			if getgenv().LevelFarm and (CFrameQuest.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 1200 then
                ByPass(CFrameQuest)
                local LibraryNotify = loadstring(game:HttpGet("https://raw.githubusercontent.com/ZoiIntra/luable/main/notify.lua"))()
                LibraryNotify:Notification({ Text = "Alchemy Hub : Farming...", Duration = 1 })
            end
